...
# path to csv
P_dashboard_paddyareadetail= os.getcwd()+r"/dummy/dashboard_paddyareadetail.csv"
P_dashboard_paddyareainfo= os.getcwd()+r"/dummy/dashboard_paddyareainfo.csv"
P_dashboard_paddyareariskdisease=os.getcwd()+r"/dummy/dashboard_paddyareariskdisease.csv"
P_information_risk=os.getcwd()+r"/dummy/information_disease.csv"
P_information_risksolution=os.getcwd()+r"/dummy/information_solution.csv"
P_information_risksolutionrelationship=os.getcwd()+r"/dummy/information_risksolutionrelationship.csv"
P_information_riskrecommendation = os.getcwd()+r"/dummy/information_recommendation.csv"
P_information_riskrecommendationrelationship = os.getcwd()+r"/dummy/information_riskrecommendationrelationship.csv"

# # Full path to the directory immediately above your django project directory
your_djangoproject_home=r"C:\Users\User\Code\UMHackathon\AI-NARI-main\ainari"
